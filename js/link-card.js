(function () {
  const cardMarkup = `
    <div class="own-flink-card">
      <div class="own-flink-heading">
        <span class="own-flink-badge">本站名片</span>
        <h2>如果你想交换友链，可以复制这份信息。</h2>
      </div>
  ...
  const applyMarkup = `
    <div class="flink-apply-card">
      <div class="flink-apply-heading">
        ...
        <p>填好后点击复制，粘贴到本页评论区，如若符合要求，我看到后会通过。</p>
        <div class="flink-apply-rules">
          <div class="flink-apply-rules-title">申请前请先确认这些条件：</div>
          <ol class="flink-apply-rules-list">
            <li>申请友链前请务必确保贵站已经添加本站友链；若审批通过后移除本站链接，本站也会移除友链并加入黑名单。</li>
            <li>请确保您的网站内容符合当地法律法规，无政治敏感内容，没有过多广告、恶意软件或恶意脚本；转载文章也请注明出处。</li>
            <li>请确保站点全局启用 HTTPS。</li>
            <li>暂时不同意商业站点与非个人网站的友链申请。</li>
            <li>已在大陆备案的网站请勿申请。</li>
            <li>博客原创内容不少于 5 篇。</li>
          </ol>
        </div>
